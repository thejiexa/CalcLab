...
<br><br><br>
<p align = "center">Лабораторная работа<br>«<strong>Простой калькулятор</strong>»<br>01.03.02 Прикладная математика и информатика</p>
...
## Задачи:
Сделать приложение простой калькулятор
## Решение:
